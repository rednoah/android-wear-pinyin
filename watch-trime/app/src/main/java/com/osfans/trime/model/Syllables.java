...
public class Syllables {
    ...
    private static final String[] PINYIN_ARRAY = {"a", "ai", "an", "ang", "ao",
    ...
    public static final NavigableSet<String> PINYIN_SET = stream(PINYIN_ARRAY).collect(toCollection(() -> new TreeSet<>(String.CASE_INSENSITIVE_ORDER)));
